...
module.exports.search = (req, res) => {
    ...
    Products.find({
        $or: [
            { pname: { $regex: search, $options: 'i' } }, // Case insensitive search for product name
            { pdesc: { $regex: search, $options: 'i' } }, // Case insensitive search for product description
            { price: { $regex: search, $options: 'i' } }, // Case insensitive search for price
        ]
    })
    .then((results) => {
